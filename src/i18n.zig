...
const us = .{
    ...
    .msg_repair_start = "Repairing: stopping bridge, reattaching USB, restarting bridge and client...",
    .msg_repair_usb_ok = "Repair: USB-Serial scanner detected (/dev/ttyUSB0).",
    .msg_repair_usb_failed = "Repair FAILED: USB-Serial scanner not detected after 15s. Check the Honeywell 1900 (CH340) connection and run setup_usb.bat manually.",
    .msg_repair_bridge_ok = "Repair: bridge restarted.",
    .msg_repair_bridge_failed = "Repair FAILED: bridge did not restart.",
    .msg_repair_done = "Repair complete. Client connecting to {s}. Scan now to verify.",
    ...
    .msg_client_restarted = "client restarted (attempt {d})",
    .msg_client_restart_failed = "client restart failed: {s}",
    .msg_log_open_ok = "log file opened",
    .msg_log_open_failed = "log file not found",
    .msg_scans_open_ok = "scans backup opened",
    .msg_scans_open_failed = "scans backup not found",
    .msg_scans_backup_failed = "scans backup write failed",
...
const pt_br = .{
    ...
    .msg_repair_start = "Reparando: parando bridge, reattach USB, reiniciando bridge e cliente...",
    .msg_repair_usb_ok = "Reparo: scanner USB-Serial detectado (/dev/ttyUSB0).",
    .msg_repair_usb_failed = "REPARO FALHOU: scanner USB-Serial nao detectado apos 15s. Verifique a conexao do Honeywell 1900 (CH340) e rode setup_usb.bat manualmente.",
    .msg_repair_bridge_ok = "Reparo: bridge reiniciado.",
    .msg_repair_bridge_failed = "REPARO FALHOU: bridge nao reiniciou.",
    .msg_repair_done = "Reparo concluido. Cliente conectando em {s}. Faca um scan para verificar.",
...
.msg_client_start_failed = "falha ao iniciar cliente: {s}",
    .msg_client_connecting = "cliente conectando a {s}",
    .msg_client_stopped = "cliente parado",
    .msg_client_restarted = "cliente reiniciado (tentativa {d})",
    .msg_client_restart_failed = "falha ao reiniciar cliente: {s}",
    .msg_log_open_ok = "arquivo de log aberto",
    .msg_log_open_failed = "arquivo de log não encontrado",
    .msg_scans_open_ok = "backup de scans aberto",
    .msg_scans_open_failed = "backup de scans não encontrado",
    .msg_scans_backup_failed = "falha ao gravar backup de scans",
